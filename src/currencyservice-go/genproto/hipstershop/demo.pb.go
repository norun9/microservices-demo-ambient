...
const file_demo_proto_rawDesc = "" +
	...
	"\ato_code\x18\x02 \x01(\tR\x06toCode\"\a\n" +
	"\x05Empty2\xb7\x01\n" +
	...
	"\aConvert\x12&.hipstershop.CurrencyConversionRequest\x1a\x12.hipstershop.Money\"\x00BfZdgithub.com/norun9/microservices-demo-ambient/src/currencyservice-go/genproto/hipstershop;hipstershopb\x06proto3"
...
var file_demo_proto_goTypes = []any{
	...
	(*GetSupportedCurrenciesResponse)(nil), // 1: hipstershop.GetSupportedCurrenciesResponse
	(*CurrencyConversionRequest)(nil),      // 2: hipstershop.CurrencyConversionRequest
	(*Empty)(nil),                          // 3: hipstershop.Empty
}
var file_demo_proto_depIdxs = []int32{
	0, // 0: hipstershop.CurrencyConversionRequest.from:type_name -> hipstershop.Money
	3, // 1: hipstershop.CurrencyService.GetSupportedCurrencies:input_type -> hipstershop.Empty
	2, // 2: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	1, // 3: hipstershop.CurrencyService.GetSupportedCurrencies:output_type -> hipstershop.GetSupportedCurrenciesResponse
	0, // 4: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money

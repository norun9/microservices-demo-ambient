...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=genproto.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\bgenproto\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\x96\x01\n" +
	"\x13HealthCheckResponse\x12C\n" +
	"\x06status\x18\x01 \x01(\x0e2+.genproto.HealthCheckResponse.ServingStatusR\x06status\":\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x022N\n" +
	"\x06Health\x12D\n" +
	"\x05Check\x12\x1c.genproto.HealthCheckRequest\x1a\x1d.genproto.HealthCheckResponseB7Z5github.com/norun9/microservices-demo-ambient/genprotob\x06proto3"
...
var file_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: genproto.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: genproto.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: genproto.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: genproto.HealthCheckResponse.status:type_name -> genproto.HealthCheckResponse.ServingStatus
	1, // 1: genproto.Health.Check:input_type -> genproto.HealthCheckRequest
	2, // 2: genproto.Health.Check:output_type -> genproto.HealthCheckResponse
